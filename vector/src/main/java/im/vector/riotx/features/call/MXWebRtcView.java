...
public class MXWebRtcView extends ViewGroup {
    ...
    /**
     * The indicator which determines whether this {@code MXWebRtcView} is to
    ...
    /**
     * The scaling type this {@code MXWebRtcView} is to apply to the video
     ...
     * that is a child of a {@code MXWebRtcView} to {@code MXWebRtcView} extending
    ...
    /**
     * Sets the z-order of this MXWebRTCView in the stacking space of all
